...
class _AddSalesOrExpensesState extends State<AddSalesOrExpenses> {
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border(bottom: BorderSide(width: 0.5, color: (salesTab) ? fagoSecondaryColor : Colors.transparent),
                        ),
                      ),
                      child: Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (_expensesContoller
                        ...
                        "" &&
                        selectedDate.toString() != "" &&
                        selectedExpenseCategoryId != "" && _expensesContoller.expenseAmountController.text != "") {
  ...
  Future<void> createBusinessSales(BuildContext context) async {
    ...
    if (response.statusCode == 200) {
      await getCustomers();
      await getSuppliers();
      await getBusinessExpenseCategories();
      if (!mounted) return;
  ...
  Future<void> createBusinessExpense(BuildContext context) async {
    ...
    final response = await _expensesContoller.createBusinessExpense(
      ...
      amount: _expensesContoller.expenseAmountController.text,
    );
  ...
  Future<void> getSuppliers() async {
    final companyId = _companyController.company!.id!;
    final response = await _supplierController.getSuppliers(companyId: companyId);
