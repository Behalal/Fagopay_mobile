...
import 'package:fagopay/screens/dashboard/widgets/banks_dropdown.dart';
import 'package:fagopay/screens/dashboard/widgets/head_style_extra_pages.dart';
import 'package:fagopay/screens/dashboard/widgets/transaction_form.dart';
...
class FagoToBank extends ConsumerStatefulWidget {
  User userDetails;
  FagoToBank({super.key, required this.userDetails});

  @override
  ConsumerState<FagoToBank> createState() => _FagoToBankState();
}

class _FagoToBankState extends ConsumerState<FagoToBank> {
