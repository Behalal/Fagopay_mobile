...
class _TransactionHistoryState extends State<TransactionHistoryPage> {
  ...
  @override
  void initState() {
    _userController.switchedAccountType == 2 ? _transactionController.getBusinessTransactionHistory(type: 1) : _transactionController.getTransactionHistory(type: 1);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TransactionController>(
      init: TransactionController(),
        builder: (controller){
      return Scaffold(
        body: _userController.switchedAccountType == 2 ?
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 2.h),
                !isFilterLoading  ?
                Container():  _transactionController.businessTransactionHistory.isEmpty || _transactionController.businessTransactionHistory == [] ||
          _transactionController.transactionHistory.isEmpty || _transactionController.transactionHistory == []? const SizedBox() :
                GestureDetector(
                  onTap:(){
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(padding: const EdgeInsets.symmetric(vertical: 3),
                        width: 23.w, margin: EdgeInsets.only(right: 1.5.h),
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(3), border: Border.all(color: transactionKeys)),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                      ...
                      Obx(() {
                        return _transactionController.txFilterData == TxFlters.unActive ? Container() :
                        GestureDetector(
                            onTap: (){
                              _transactionController.getBusinessTransactionHistory(type: 1);
                ...
                Padding(
                    ...
                    child: _transactionController.onLoadingBusinessTransactionHistoryLoadingState == true &&
                        _transactionController.onLoadingBusinessTransactionHistoryErrorState == false ?
                        // _transactionController.businessTransactionHistory.isEmpty ||
                        // _transactionController.businessTransactionHistory == [] ?
                    Center(child: LoadingWidget(
                      color: fagoSecondaryColor,
                      size: MediaQuery.of(context).size.height/2.5,
                    ),
                    ) : _transactionController.onLoadingBusinessTransactionHistoryLoadingState == false &&
                        _transactionController.onLoadingBusinessTransactionHistoryErrorState == false &&
                        _transactionController.businessTransactionHistory.isEmpty ||
                        _transactionController.businessTransactionHistory == [] ?
                    Center(
                      child: Column(
                        ...
                        shrinkWrap: true,
                        itemCount: _transactionController.businessTransactionHistory.length,
                        separatorBuilder: (context, index) =>
                            SizedBox(
                              height: 1.5.h,
                            ),
                        itemBuilder: (context, index) {
                          var item = _transactionController.businessTransactionHistory[index];
                          return InkWell(
                            onTap: () {
                              setState(() {
                                businessTransactionType = index;
                              });
                            },
                            child: InkWell(
                              onTap: () {
                                  ...
                                  children: [
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                        Row(
                                          children: [
                                            SvgPicture.asset(item.transactionType != TransactionType.CREDIT ? 'assets/icons/transfer_icon.svg' : 'assets/icons/recived_from_icon.svg'),
                                          ],
                                        ),
                                        SizedBox(width: 2.h,),
                                        Expanded(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                    padding: EdgeInsets.symmetric(vertical: 0.h, horizontal: 2.5.w),
                    child: _transactionController.onLoadingTransactionHistoryLoadingState == true && _transactionController.onLoadingTransactionHistoryErrorState == false &&
                        _transactionController.transactionHistory.isEmpty || _transactionController.transactionHistory == [] ?
                    Center(child: LoadingWidget(
                      color: fagoSecondaryColor,
                      size: MediaQuery.of(context).size.height/2.5,
                    ),
                    ) : _transactionController.onLoadingTransactionHistoryLoadingState == false && _transactionController.onLoadingTransactionHistoryErrorState == false &&
                        _transactionController.transactionHistory.isEmpty || _transactionController.transactionHistory == [] ?
                    Center(
                      child: Column(
                        children: [
                        ...
                        physics: const NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
                        itemCount: _transactionController.transactionHistory.length,
                        separatorBuilder: (context, index) =>
                            SizedBox(
                              height: 1.5.h,
                            ),
                        itemBuilder: (context, index) {
                          var item = _transactionController.transactionHistory[index];
                          return InkWell(
                            onTap: () {
                              setState(() {
                      ...
                      GestureDetector(
                        onTap: (){
                          if(startDateString.isEmpty){
                            ...
                            _userController.switchedAccountType == 2 ? _transactionController.getBusinessTransactionHistory(type: 2, endDate: endDateDateString ,filter: filter,startDate:  startDateString) : _transactionController.getTransactionHistory(type: 2,endDate: endDateDateString ,filter: filter,startDate:  startDateString);
                          }
                        },
                        child: Center(
                          child: AuthButtons(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Constant().btn(color: buttonColor,text: 'Share Receipt',img: 'assets/icons/share.png',onTap: (){
                shareImage();
              }),
              const SizedBox(height: 10),
