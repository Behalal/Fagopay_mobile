...
class _BuyAirtimeState extends State<BuyAirtime> {
  ...
  late String serviceProviderValue;
  @override
  void initState() {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  onChanged: ((value) {
                    setState(() {
                      buyAirtimeFields.setPhone = phoneController.text;
                    });
                  }),
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  onChanged: ((value) {
                    setState(() {
                      buyAirtimeFields.setAmount = amountController.text;
                    });
                  }),
                  style: const TextStyle(
                      fontFamily: "Work Sans",
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (BuildContext context) => ConfirmTransactions(
                          action: 'buy_airtime',
