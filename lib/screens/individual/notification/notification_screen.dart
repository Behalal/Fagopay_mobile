  ...
  Widget build(BuildContext context) {
    return GetBuilder<NotificationController>(
      ...
      return SafeArea(top: false, bottom: false,
        child: Scaffold(
          body: controller.onLoadingNotification == true && controller.onNotificationResponseError == false ?
          const Center(child: CupertinoActivityIndicator(color: fagoSecondaryColor,),)
              : controller.onLoadingNotification == false && controller.onNotificationResponseError == false && controller.notificationResponse!.data!.notifications!.isEmpty ?
          Center(
            child: Padding(
